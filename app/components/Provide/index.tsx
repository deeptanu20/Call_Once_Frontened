                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
                    ...
                    <div className='col-span-6 flex justify-center'>
                        <div className="flex flex-col align-middle justify-center p-10">
                            <p className="text-4xl lg:text-6xl pt-4 font-semibold lh-81 mt-5 text-center lg:text-start">Our Popular Services</p>
                            ...
                            <Link href={'/business'} className="mt-4 text-xl font-medium text-blue flex gap-2 mx-auto lg:mx-0 space-links">Book a Service<Image src={'/assets/provide/arrow.svg'} alt={'arrow'} width={20} height={20} /></Link>
